...
const WainwrightCount = (props: WainwrightCountProps) => {
  ...
  const percentage = Math.round(baggedWainwrightList.length / wainwrightList.length * 1000) / 10

  return (
    <div>
      <h3>Progress</h3>

      You have bagged <strong>{baggedWainwrightList.length} out of {wainwrightList.length} Wainwrights</strong>! That is {percentage}%!
